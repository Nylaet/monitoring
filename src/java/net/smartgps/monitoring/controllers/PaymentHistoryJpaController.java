 ...
 * @author Panker
 */
@ManagedBean(name="paymentHistory")
@SessionScoped
public class PaymentHistoryJpaController implements Serializable {

    public PaymentHistoryJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(PaymentHistory paymentHistory) throws RollbackFailureException, Exception {
    ...
    public void edit(PaymentHistory paymentHistory) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
    ...
    public PaymentHistory findPaymentHistory(Long id) {
        EntityManager em = getEntityManager();
        try {
